...
- It injects ENIs into subnets in a VPC
...
- AD connector allows us to use AWS services which do require an AD directory (such as Workspaces) and uses this with an on-premises directory service => we don't need to deploy additional AD directory in AWS
...
- AD directory is placed in 2 subnets in a VPC in different availability zones => resilient to AZ failure
